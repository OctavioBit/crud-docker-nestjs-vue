...
var Photo = function () {
    ...
    var Photo = _classThis = /** @class */ (function () {
        function Photo_1() {
            ...
            this.views = (__runInitializers(this, _filename_extraInitializers), __runInitializers(this, _views_initializers, void 0));
            this.isPublished = (__runInitializers(this, _views_extraInitializers), __runInitializers(this, _isPublished_initializers, void 0));
            __runInitializers(this, _isPublished_extraInitializers);
        }
        return Photo_1;
    }());
    ...
    (function () {
        ...
        _name_decorators = [(0, typeorm_1.Column)({ length: 500 })];
        _description_decorators = [(0, typeorm_1.Column)('text')];
        _filename_decorators = [(0, typeorm_1.Column)()];
        _views_decorators = [(0, typeorm_1.Column)('int')];
