# Modular Web Application Boilerplate

- CQRS
- Full Dockerized
- A Service layer that transform itself to handle an entity when it ~~sees it~~ passed by parameter 
- Technologies: NodeJS NestJS NestCQRS MySQL Prisma Vue Vite Vuetify Pinia Axios Docker Github Actions
- Includes a CRUD to see it in action
